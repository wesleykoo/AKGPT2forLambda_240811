...
train_loader = DataLoaderLite(B=16, T=1024) # previously 4,32--> GPT-2, 16,1024
...
for step in range(50):
    ...
    print(f"step {step:4d} | loss: {loss.item():.6f} | lr: {lr:.4e} | norm: {norm:.4f} | dt: {dt:.2f}ms | tok/sec: {tokens_per_second:.2f}")
